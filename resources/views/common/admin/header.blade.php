                ...
                <div id="kt_aside_menu" class="aside-menu my-4" data-menu-vertical="1" data-menu-scroll="1"
                    ...
                    <ul class="menu-nav">
                        ...
                        <li class="menu-item" aria-haspopup="true">
                            <a href="{{ route('admin.cate') }}" class="menu-link">
                                <span class="svg-icon menu-icon">
                        ...
                        <li class="menu-item" aria-haspopup="true">
                            <a href="{{ route('admin.genre') }}" class="menu-link">
                                <span class="svg-icon menu-icon">
                                    <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-left-panel-2.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        ...
                        <li class="menu-item" aria-haspopup="true">
                            <a href="{{ route('admin.movie') }}" class="menu-link">
                                <span class="svg-icon menu-icon">
                                    <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-left-panel-2.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        ...
                        <li class="menu-item" aria-haspopup="true">
                            <a href="{{ route('admin.showtime') }}" class="menu-link">
                                <span class="svg-icon menu-icon">
                                    <!--begin::Svg Icon | path:assets/media/svg/icons/Layout/Layout-left-panel-2.svg-->
                                    <svg xmlns="http://www.w3.org/2000/svg" xmlns:xlink="http://www.w3.org/1999/xlink"
                                        width="24px" height="24px" viewBox="0 0 24 24" version="1.1">
                        ...
                        <li class="menu-item" aria-haspopup="true">
                            <a href="{{ route('admin.user') }}" class="menu-link">
                                ...
                                <span class="menu-text">Quản lý nguời dùng</span>
                            </a>
                        </li>
                    ...
                    <div class="topbar">
                        ...
                        <div class="dropdown">
                            <button class="btn btn-secondary dropdown-toggle" type="button" id="dropdownMenuButton1" data-bs-toggle="dropdown" aria-expanded="false">
                                        ...
                                        <span
                                            class="font-weight-bolder font-size-base d-none d-md-inline mr-3">{{Auth::user()->name}}</span>
                            </button>
