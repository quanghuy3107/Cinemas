...
<div class="subheader py-2 py-lg-4 subheader-solid" id="kt_subheader">
    <div class="container-fluid d-flex align-items-center justify-content-between flex-wrap flex-sm-nowrap">
        ...
        <div class="d-flex align-items-center flex-wrap mr-2">
            <!--begin::Page Title-->
            <h5 class="text-dark font-weight-bold mt-2 mb-2 mr-5">Thông tin danh mục phim</h5>
            <!--end::Page Title-->
        </div>
        <!--end::Info-->
    </div>
            ...
            <div class="card-header flex-wrap border-0 pt-6 pb-0">
                <div class="card-title">
                    <h3 class="card-label">Thông tin chung
                        <span class="d-block text-muted pt-2 font-size-sm">thông tin các danh mục phim</span>
                    </h3>
                </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <span style="overflow: visible; position: relative; width: 125px;">
                                    <a href="{{ route('admin.updateCategory', ['id'=>$item->category_Id]) }}"
                                    ...
                                    <a href="{{ route('admin.deleteCategory', ['id'=>$item->category_Id]) }}"
